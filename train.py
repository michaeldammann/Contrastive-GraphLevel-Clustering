...
from modules.graph_transform import graph_transform_all
...
if __name__ == "__main__":
    ...
    if args.dataset == "CIFAR-10":
        ...
        dataset = TUDataset(root='/home/md/PycharmProjects/CC4Graphs/datasets/', name="NCI1", transform=graph_transform_all)
    else:
