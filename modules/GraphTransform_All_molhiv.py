...
class GraphTransform_All_molhiv:
    ...
    def drop_nodes(self, data, aug_ratio):
        ...
        new_data = Data(x=data.x[idx_nondrop], edge_index=edge_index, y=data.y, num_nodes=data.x[idx_nondrop].size()[0], edge_attr=data.edge_attr)
    ...
    def permute_edges(self, data, aug_ratio):
        ...
        new_data = Data(x=data.x, edge_index=data.edge_index, y=data.y, num_nodes=data.x.size()[0], edge_attr=data.edge_attr)
        # data.num_nodes = data.x.size()
        return new_data
    ...
    def subgraph(self, data, aug_ratio):
        ...
        data.edge_index = edge_index
        new_data = Data(x=deepcopy(data.x), edge_index=deepcopy(edge_index), y=data.y, num_nodes=data.x.size()[0], edge_attr=data.edge_attr)
        # data.num_nodes = data.x.size()
